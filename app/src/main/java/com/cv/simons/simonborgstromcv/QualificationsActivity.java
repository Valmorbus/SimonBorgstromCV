...
public class QualificationsActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayList<Qualifications> qualificationsList = new ArrayList<Qualifications>();
        ...
        try {
            ...
            for (int i = 0; i < m_jArry.length(); i++) {
                ...
                qualificationsList.add(new Qualifications(jo_inside.getInt("Id"), jo_inside.getString("Name")));
            }
        } catch (JSONException e) {
            e.printStackTrace();
        }

        ArrayAdapter<Qualifications> arrayAdapter = new ArrayAdapter<>(QualificationsActivity.this,
                android.R.layout.simple_list_item_1, android.R.id.text1, qualificationsList);

        ListView qListView = (ListView) findViewById(R.id.listView3);
        qListView.setAdapter(arrayAdapter);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.qualifications, menu);
        return true;
    }
    ...
    private String loadJSONFromAsset() {
        String json = null;
        try {
            InputStream is = this.getAssets().open("GetQualifications.json");
